  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        ...
        labelName: 'Champions League',
        isAssetsImage: true,
        imageName: 'assets/champions.png',
      ),
      DrawerList(
        index: DrawerIndex.FeedBack,
        labelName: 'Premiere League',
        isAssetsImage: true,
        imageName: 'assets/prem.png',
      ),
      DrawerList(
        index: DrawerIndex.Invite,
        labelName: 'La Liga',
        isAssetsImage: true,
        imageName: 'assets/laliga_logo.png',
      ),
      DrawerList(
        index: DrawerIndex.Share,
        labelName: 'Serie A',
        isAssetsImage: true,
        imageName: 'assets/A.png',
      ),
//      DrawerList(
                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.asset('assets/ramos.jpg'),
                            ),
                          ),
                        ),
                      );
